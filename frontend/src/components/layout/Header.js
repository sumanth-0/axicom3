...
import styles from "../styles/InnovatorsHub.module.css"; // Ensure this path is correct
      ...
      <section className={styles.content}>
        ...
        <div className={styles.cardContainer}>
          <InfoCard
            ...
            navigateTo="/elevating-startups" // Path for Elevating Startups
          />
          <InfoCard
            ...
            navigateTo="/accelerating-startups" // Path for Accelerating Startups
          />
        </div>
        <div
