...
const Footer = () => {
  ...
  const candidateLinks = [
    ...
    { name: 'Browse Employers', path: '/employers' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-6">
              ...
              <span className="text-2xl font-bold">WeXtGen</span>
            </div>
            <div className="text-gray-400">
              <p className="mb-4">
                <span className="block">Call now:</span>
                <span className="text-white font-semibold">987654321</span>
              </p>
              <address className="not-italic">
                6391 Elgin St. Celina, cols street make town banglore
              </address>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 WeXtGen. All rights Reserved
          </p>
